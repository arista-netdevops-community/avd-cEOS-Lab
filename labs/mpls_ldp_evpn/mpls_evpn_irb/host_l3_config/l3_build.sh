...
echo "[INFO] Configuring clab-mplsevpnirb-client1"
docker exec -it  clab-mplsevpnirb-client1 /bin/sh -c "$CMD1"

echo "[INFO] Configuring clab-mplsevpnirb-client2"
docker exec -it  clab-mplsevpnirb-client2 /bin/sh -c "$CMD2"

echo "[INFO] Configuring clab-mplsevpnirb-client3"
docker exec -it  clab-mplsevpnirb-client3 /bin/sh -c "$CMD3"

echo "[INFO] Configuring clab-mplsevpnirb-client4"
docker exec -it  clab-mplsevpnirb-client4 /bin/sh -c "$CMD4"

echo "[INFO] Completed"

echo "Use [ docker exec -it clab-mplsevpnirb-client<x> /bin/sh ] to login in host."