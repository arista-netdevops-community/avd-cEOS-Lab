...
echo "[INFO] Configuring clab-mplsl2evpn-client1"
docker exec -it  clab-mplsl2evpn-client1 /bin/sh -c "$CMD1"

echo "[INFO] Configuring clab-mplsl2evpn-client2"
docker exec -it  clab-mplsl2evpn-client2 /bin/sh -c "$CMD2"

echo "[INFO] Configuring clab-mplsl2evpn-client3"
docker exec -it  clab-mplsl2evpn-client3 /bin/sh -c "$CMD3"

echo "[INFO] Configuring clab-mplsl2evpn-client4"
docker exec -it  clab-mplsl2evpn-client4 /bin/sh -c "$CMD4"

echo "[INFO] Completed"

echo "Use [ docker exec -it clab-mplsl2evpn-client<x> /bin/sh ] to login in host."
