...
echo "[INFO] Configuring clab-samh-client1"
docker exec -it  clab-samh-client1 /bin/sh -c "$CMD1"

echo "[INFO] Configuring clab-samh-client2"
docker exec -it  clab-samh-client2 /bin/sh -c "$CMD2"

echo "[INFO] Configuring clab-samh-client3"
docker exec -it  clab-samh-client3 /bin/sh -c "$CMD3"

echo "[INFO] Configuring clab-samh-client4"
docker exec -it  clab-samh-client4 /bin/sh -c "$CMD4"

echo "[INFO] Completed"

echo "Use [ docker exec -it clab-samh-client<x> /bin/sh ] to login in host."