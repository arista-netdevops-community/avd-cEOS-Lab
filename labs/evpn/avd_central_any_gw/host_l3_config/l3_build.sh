...
echo "[INFO] Configuring clab-avdcentralgw-client1"
docker exec -it  clab-avdcentralgw-client1 /bin/sh -c "$CMD1"

echo "[INFO] Configuring clab-avdcentralgw-client2"
docker exec -it  clab-avdcentralgw-client2 /bin/sh -c "$CMD2"

echo "[INFO] Configuring clab-avdcentralgw-client3"
docker exec -it  clab-avdcentralgw-client3 /bin/sh -c "$CMD3"

echo "[INFO] Configuring clab-avdcentralgw-client4"
docker exec -it  clab-avdcentralgw-client4 /bin/sh -c "$CMD4"

echo "[INFO] Completed"

echo "Use [ docker exec -it clab-avdcentralgw-client<x> /bin/sh ] to login in host."