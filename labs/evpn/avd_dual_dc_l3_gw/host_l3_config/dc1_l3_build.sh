...
echo "[INFO] Configuring clab-evpnl3gw-dc1-client1"
docker exec -it  clab-evpnl3gw-dc1-client1 /bin/sh -c "$CMD1"

echo "[INFO] Configuring clab-evpnl3gw-dc1-client2"
docker exec -it  clab-evpnl3gw-dc1-client2 /bin/sh -c "$CMD2"

echo "[INFO] Configuring clab-evpnl3gw-dc1-client3"
docker exec -it  clab-evpnl3gw-dc1-client3 /bin/sh -c "$CMD3"

echo "[INFO] Configuring clab-evpnl3gw-dc1-client4"
docker exec -it  clab-evpnl3gw-dc1-client4 /bin/sh -c "$CMD4"

echo "[INFO] Completed"

echo "Use [ docker exec -it clab-evpnl3gw-dc1-client<x> /bin/sh ] to login in host."